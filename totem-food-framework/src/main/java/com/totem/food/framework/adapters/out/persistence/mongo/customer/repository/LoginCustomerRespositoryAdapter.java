...
@AllArgsConstructor
@Component
public class LoginCustomerRespositoryAdapter implements ILoginRepositoryPort<Optional<CustomerDomain>> {
    ...
    @Override
    public Optional<CustomerDomain> findByCadastre(String cpf, String password) {
